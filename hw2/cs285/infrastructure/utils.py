...
def sample_trajectory(
    ...
    while True:
        ...
        recent_ob = obs[-1] if obs else ob

        # FIXME) To watach normal run
        recent_ob = ptu.from_numpy(recent_ob)
        ac = policy.get_action(recent_ob)
        ...
        steps += 1
        rollout_done: bool = (steps<= max_length and done)
